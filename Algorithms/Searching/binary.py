""""This module includes the logic for a binary search of a given array."""


class Binary:
    """"Class that allows to use functions for binary searching."""
    ...
    def search(value_to_search, array_size, array):
        ...
        while low <= high:
            mid = int(low + ((high - low) / 2))  # Get the mid index
...
if __name__ == "__main__":
    ...
    test_array_index = Binary.search(value_to_find, len(test_array), test_array)
